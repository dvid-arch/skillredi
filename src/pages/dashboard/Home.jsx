            ...
            <div className="max-w-7xl mx-auto flex flex-col gap-6 sm:gap-10">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-0">
                    <div className='flex flex-col gap-3'>
                        ...
                        <p className="text-gray-600 mb-2 sm:mb-6">Welcome to your learning dashboard</p>
                    </div>
                    <div className="text-right flex flex-col gap-3 w-full sm:w-auto mt-4 sm:mt-0">
                ...
                {/* --- Welcome Banner --- */}
                <div className="bg-white shadow-sm p-4 sm:p-6 rounded-[20px]">
                    <h2 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-4">Welcome to your Learning Journey</h2>
                    <p className="text-gray-600 mb-4 sm:mb-6">Track your progress, earn badges and become a master of your skills</p>

                    <div className="flex flex-wrap gap-4">
                        <button className="flex items-center gap-2 bg-white hover:bg-gray-50 text-green-700 px-4 sm:px-6 py-2 sm:py-3 rounded-md border border-gray-200 font-medium text-sm sm:text-base">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 sm:gap-8 mb-6 sm:mb-8">
                    ...
                    <div className="lg:col-span-3 bg-white p-4 sm:p-6 rounded-lg shadow-sm">
                        <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-4">Course Progress</h3>
                        ...
                        {/* Up Next Section */}
                        <div className="p-4 sm:p-6 bg-green-800 rounded-[20px] text-white flex flex-col gap-4 sm:gap-6">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2"><BookOpen size={16} color="white" /> Up Next</div>
                                <div className="flex items-center gap-2 py-1 px-3 border rounded-[20px] text-sm"><Code2 /> 25XP</div>
                            </div>
                            <div className="flex flex-col gap-2 sm:gap-3">
                                <h4 className="text-base sm:text-lg">Arrow Functions</h4>
                                <p className="text-sm sm:text-base">Learn the modern JavaScript arrow function syntax</p>
                            </div>
                            <button className="py-2 sm:py-3 w-full sm:w-fit rounded-[8px] bg-white px-4 sm:px-6 text-green-800 border border-gren-800 text-sm sm:text-base">Continue Learning</button>
                        </div>
                    </div>

                    {/* --- Recent Achievements Card --- */}
                    <div className="bg-white lg:col-span-2 p-4 sm:p-6 rounded-lg shadow-sm">
                        <h3 className="text-base sm:text-lg font-semibold text-gray-800 mb-4">Recent Achievements</h3>
                        ...
                        <div className="flex items-center justify-center gap-4 text-center">
                            ...
                            <div className="flex flex-col items-center">
                                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gradient-to-br from-teal-400 to-cyan-600 flex items-center justify-center mb-2 shadow-md">
                                    {/* Use Lucide Code2 icon */}
                                    <Code2 size={32} strokeWidth={iconStrokeWidth} className="h-8 w-8 sm:h-10 sm:w-10 text-white" />
                                </div>
                                <h4 className="font-semibold text-gray-700 text-xs sm:text-sm">Functions Guru</h4>
                ...
                {/* --- Activity Feed Card --- */}
                <div className="bg-white px-4 sm:px-6 py-4 rounded-lg shadow-sm flex flex-col gap-4 sm:gap-6">
                    <h3 className="text-xl sm:text-[36px] font-[500] text-gray-800">Activity Feed</h3>
                    <div className="flex flex-col gap-4 sm:gap-6">
                        {activityFeed.map((item) => {
                            const Icon = item.icon; // Get the Lucide icon component
                            return (
                                <div key={item.id} className="flex items-start justify-between gap-3 sm:gap-4 pb-4 sm:pb-6 border-b border-gray-200 last:border-b-0">
                                    <div className="flex items-center gap-3 sm:gap-6">
                                        ...
                                        <div className="flex flex-col gap-1 sm:gap-3">
                                            <p className="text-sm sm:text-[18px] font-medium text-gray-700">{item.title}</p>
                                            <p className="text-xs sm:text-base text-gray-600">{item.description}</p>
                                            <p className="text-xs sm:text-base text-gray-400 mt-1">{item.time}</p>
                                        </div>
                                    </div>
                                    {/* Use Lucide Share2 icon */}
                                    <button className="text-gray-400 hover:text-gray-600 flex-shrink-0 hidden sm:block">
